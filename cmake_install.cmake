...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/usr/lib/librabbit.so" AND
    ...
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/lib/librabbit.so"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/lib/librabbit.so")
...
file(INSTALL DESTINATION "/usr/lib" TYPE SHARED_LIBRARY FILES "/home/mirmik/project/rabbit/librabbit.so")
  if(EXISTS "$ENV{DESTDIR}/usr/lib/librabbit.so" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/lib/librabbit.so")
    endif()
  endif()
endif()
